    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                color: diffHomeBtn.hovered ? "#e2e8f0" : "#ffffff"
                radius: 10
                border.color: "#cbd5e1"
                border.width: 1
            }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Button {
                    id: levelsBackBtn
                    background: Rectangle {
                        color: levelsBackBtn.hovered ? "#e2e8f0" : "#ffffff"
                        radius: 8
                        border.color: "#cbd5e1"
                    }
                    contentItem: Text {
                    ...
                    onClicked: currentScreen = "difficulty"
                }
                Button {
                    id: levelsHomeBtn
                    background: Rectangle {
                        color: levelsHomeBtn.hovered ? "#e2e8f0" : "#ffffff"
                        radius: 8
                        border.color: "#cbd5e1"
                    }
                    contentItem: Text {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            text: "← Levels"
                            background: Rectangle {
                                color: gameBackBtn.hovered ? "#2980b9" : "#3498db"
                                radius: 8
                            }
                            contentItem: Text {
                                text: "← Levels"
                        ...
                        Button {
                            ...
                            text: " Home"
                            background: Rectangle {
                                color: gameHomeBtn.hovered ? "#2980b9" : "#3498db"
                                radius: 8
                            }
                            contentItem: Text {
                                text: " Home"
